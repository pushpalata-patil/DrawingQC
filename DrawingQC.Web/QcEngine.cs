...
/// <summary>
/// Cross-platform drawing-QC engine: reads a zip of drawing PDFs, compares the drawing
/// numbers in each PDF's file name against the numbers printed inside the PDF, detects
/// duplicates across the whole set, and builds a colour-coded Excel report.
/// </summary>
public static class QcEngine
{
    ...
    /// <summary>Analyse every PDF in the given zip stream.</summary>
    public static List<PdfResult> Analyze(Stream zipStream)
    {
    ...
    /// <summary>Build the 6-column, colour-coded Excel report as bytes.</summary>
    public static byte[] BuildReportBytes(List<PdfResult> results)
    {
